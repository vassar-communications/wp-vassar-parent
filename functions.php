...
if (file_exists($child_cfg_file)) {
    include($child_cfg_file);
}
...
/*	Gutenberg overrides
    ...
    add_theme_support('editor-font-sizes', array(
            array(
                'name' => __('XS', 'gutenberg-test'),
                'shortName' => __('X', 'gutenberg-test'),
                'size' => 12,
                'slug' => 'xsmall'
            ),
            array(
                'name' => __('Small', 'gutenberg-test'),
                'shortName' => __('S', 'gutenberg-test'),
                'size' => 12,
                'slug' => 'small'
            ),
            array(
        ...
        <ul>
            {{#each content}}
                <li><a href="{{item_link}}">{{item_text}}</a>
                    {{#if item_description}}
                        <div class=\'item__desc\'>{{item_description}}</div>
                    {{/if}}
                </li>
            {{/each}}
        </ul>
